...
export class RevolverBullet extends Projectile {
  public static override readonly resourceName = "revolver_bullet";
  public static readonly definition: ProjectileDefinition =
    createProjectileDefinitionForType("projectile:revolver_bullet");
