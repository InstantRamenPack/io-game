...
export class HeavyPistolBullet extends Projectile {
  public static override readonly resourceName = "heavy_pistol_bullet";
  public static readonly definition: ProjectileDefinition =
    createProjectileDefinitionForType("projectile:heavy_pistol_bullet");
