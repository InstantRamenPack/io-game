...
const rendererManifests = [
  ...
  ["tree", TreeRenderer],
  ["house_s", MapBuildingRenderer],
  ["house_xl", MapBuildingRenderer],
  ["house_l", MapBuildingRenderer],
  ["house_m", MapBuildingRenderer],
  ["barracks", MapBuildingRenderer],
  ["camp_shelter", MapBuildingRenderer],
  ["command_post", MapBuildingRenderer],
  ["fence_h", FenceRenderer],
  ["fence_v", FenceRenderer],
  ["guard_tower", MapBuildingRenderer],
  ["market_stall", MapBuildingRenderer],
  ["vehicle_wreck", MapBuildingRenderer],
  ["wall", WallRenderer],
