...
export const TowerSnapshotSchema = EntitySnapshotBaseSchema.extend({
...
export const DayNightSnapshotSchema = z.object({
  ...
  phaseElapsedTicks: NonNegativeIntSchema,
...
export const ExtractionSnapshotSchema = z.object({
  ...
  boardElapsedTicks: NonNegativeIntSchema,
  boardTimerGoalTicks: PositiveIntSchema,
  chopperElapsedTicks: NonNegativeIntSchema,
...
export const SNAPSHOT_COMPAT_DESCRIPTOR = Object.freeze({
  ...
  tower: extensionSchemaKeys(EntitySnapshotBaseSchema, TowerSnapshotSchema),
