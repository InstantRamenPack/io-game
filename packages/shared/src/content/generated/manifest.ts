...
import buildingTeslaJson from "@shared/content/building/tesla.json";
...
import itemTeslaJson from "@shared/content/item/tesla.json";
...
import blueprintTeslaJson from "@shared/content/blueprint/tesla.json";
...
export const buildingContentEntries = [
  ...
  makeParsedEntityContentEntry("building", "tesla", buildingTeslaJson),
...
export const itemContentEntries = [
  ...
  makeParsedItemContentEntry("tesla", itemTeslaJson),
...
export const blueprintContentEntries = [
  ...
  makeParsedBlueprintContentEntry("tesla", blueprintTeslaJson),
] as const;
